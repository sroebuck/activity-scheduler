...
object ActivityPlaceTest {
  ...
  val activityPlaceSet: Set[ActivityPlace] = {
    ...
    val minMaxMappings = Map("Archery" -> (2, 6), "Trail Biking" -> (2,6), "Ropes Course" -> (2,7), "High Ropes" -> (2,6), 	"Adventure Golf" -> (2,6), "Baking" -> (2,12), "Crafts" -> (2,12), "Grylls Skylls" -> (2,12), "Video workshop" -> (2,15),	"Mental Mayhem" -> (2,12), "Indoor Games" -> (5,15),	"Games Hall" -> (5,15), "Football" -> (4,14),	"Adventure Playground" -> (6,24), "Another" -> (2,8))
